defmodule Rfx.Ops.Credo.IoInspectUncomment do
  ...
  This one uncomments out the `IO.inspect` statements.
  """
  ...
  def propspec do
    [
      key: :credo_io_inspect_uncomment,
  ...
  @impl true
  defdelegate edit(source_code), to: Rfx.Edit.Credo.IoInspectUncomment
