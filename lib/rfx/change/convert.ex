defmodule Rfx.Change.Convert do
  @moduledoc """
  Dynamically generate a list of Rfx Cast Types

  Introspects the BEAM environment for all modules in the `Rfx.Change.Cast.`
  namespace.

  Used to generate dynamic a catalog of Rfx converters.  Developers can write
